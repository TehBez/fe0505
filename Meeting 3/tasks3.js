...
function task3 () {
    const answer2 = prompt('Get me n, please'); // string or null
    const n = parseInt(answer2, 10);
    const answer1 = prompt('Get me k, please'); // string or null
    const k = parseInt(answer1, 10);
    let i = 1;
    let result = '';
